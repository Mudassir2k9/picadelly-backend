...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ImagesSlider: Schema.Attribute.Component<'about.slider', false>;
    InfoDescription1: Schema.Attribute.Text;
    InfoDescription2: Schema.Attribute.Text;
    InfoHeading1: Schema.Attribute.String;
    InfoHeading2: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBuzzBuzz extends Struct.SingleTypeSchema {
  collectionName: 'buzzes';
  info: {
    displayName: 'Buzz';
    pluralName: 'buzzes';
    singularName: 'buzz';
  ...
  attributes: {
    Announcement: Schema.Attribute.Component<'buzz.announcements', false>;
    Awards: Schema.Attribute.Component<'buzz.awards', false>;
    BannerHeading: Schema.Attribute.RichText &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    copyright: Schema.Attribute.Component<'footer.term-and-condition', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    footerLinks: Schema.Attribute.Component<'footer.link', true>;
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'footer.location', true>;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNewsLandingNewsLanding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Section2_Left_Column_Description: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    Section2_Left_Column_Heading: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    Section2_Right_Column_Background_Color_Code: Schema.Attribute.String;
    Section2_Right_Column_Heading: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
...
export interface ApiServiceService extends Struct.SingleTypeSchema {
  ...
  attributes: {
    AllServices: Schema.Attribute.Component<'service.all-services', false>;
    BannerHeading: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiTalentExecutiveTalentExecutive
  extends Struct.SingleTypeSchema {
  collectionName: 'talent_executives';
  info: {
    displayName: 'Talent Executive';
    pluralName: 'talent-executives';
    singularName: 'talent-executive';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Section2Description: Schema.Attribute.RichText &
      ...
      >;
    Section2Heading: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    Section3Description: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
      ...
      >;
    Section3Heading: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
...
export interface ApiTalentOnDemandTalentOnDemand
  extends Struct.SingleTypeSchema {
  collectionName: 'talent_on_demands';
  info: {
    displayName: 'Talent On Demand';
    pluralName: 'talent-on-demands';
    singularName: 'talent-on-demand';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    BannerHeading: Schema.Attribute.RichText &
      ...
      >;
    Brand_Section_Description: Schema.Attribute.Text;
    Brand_Section_Heading: Schema.Attribute.String;
    Brands_Images: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FAQs: Schema.Attribute.Component<'talent-on-demand.faq-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    Services: Schema.Attribute.Component<
      ...
      false
    >;
    Stories: Schema.Attribute.Component<'talent-on-demand.stories', false>;
...
export interface ApiWorkWork extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Work_History: Schema.Attribute.Component<'work.work-history', true>;
  };
}
